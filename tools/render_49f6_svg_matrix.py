...
MATRIX = (
    MatrixEntry(
        ...
        (
            ...
            "--constellation-lines", "Cru,Cyg,UMa",
            "--constellation-labels", "Cru,Cyg,UMa",
            "--constellation-boundaries", "Cru,Cyg,UMa",
            "--equatorial-grid",
...
def inspect_svg(path):
    ...
    return {
        ...
        "path_elements": tags["path"],
        "use_elements": tags["use"],
