...
MATRIX = (
    ...
    *_canonical(
    ...
    MatrixEntry(
        ...
        "disjoint all-sky regions, horizon reference, and one combined mask",
    ),
    MatrixEntry(
        ...
        (
            ...
            "--position-angle", "12.5", "--horizon", "--horizon-mask",
            "--magnitude-limit", "5.0",
            "--style", "atlas", "--mode", "print",
        ),
        "explicit regional field, combined Serpens mask, and horizon crossing",
    ),
    MatrixEntry(
        "diagnostic-binocular-horizon",
        (
            "binocular", *BINOCULAR_OBSERVER, "--target", "centaurus-a",
            "--field-diameter", "6.5", "--horizon", "--horizon-mask",
            "--magnitude-limit", "11.0",
            "--style", "atlas", "--mode", "print",
        ),
        "binocular aperture with independent horizon reference and mask",
    ),
    MatrixEntry(
