...
CASES = (
    ...
    ("regional_constellation.py", (),
     ("regional", "--center-on", "constellation:Cru", "--observer-location",
      "La Ligua", "--observer-time", "2026-08-15 21:00")),
    ("regional_constellation_group.py", (),
     ("regional", "--center-on", "constellation:Sgr,Sco,Oph,Ser",
    ...
    ("circumpolar.py", (),
     ("circumpolar", "--observer-location", "La Ligua",
      "--observer-time", "2026-08-15 21:00")),
    ("binocular_object.py", (),
     ("binocular", "--center-on", "target:centaurus-a", "--observer-location",
