"""Visual verification of the independent LMC and SMC isophote layers."""
...
def generate(output):
    ...
    style.configure_axes(ax, title="Magellanic Cloud isophotes")
...
def main():
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=(
            "magellanic-cloud-isophotes-output/full-sky.png"
        ),
    )
