...
def atlas_chart_style(
    ...
    *,
    ...
    solar = replace(
        style.solar,
        venus_color="#FFE6A3",
        venus_symbol_size=style.solar.venus_symbol_size * symbol_scale,
        venus_linewidth=style.solar.venus_linewidth * line_scale,
        venus_label_fontsize=(
            style.solar.venus_label_fontsize * font_scale
        ),
    )
    grids = replace(
        style.grids,
