...
- [`observer_time_sequence_oracle_49j3g.md`](observer_time_sequence_oracle_49j3g.md)
  — active 49J.3G canonical observer-time sequence audit.

The accepted 49J.0 through 49J.3F records are archived under
