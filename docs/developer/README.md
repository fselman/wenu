...
- [`test_practice_decisions_49j2.md`](test_practice_decisions_49j2.md) — active
  49J.2 Adopt/Adapt/Reject/Defer policy proposal, including the new-test
  admission and duplication-control rule.
