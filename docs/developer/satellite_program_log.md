...
The candidate admits for later review only an offline general JSON advisory
...
reserved unsupported profile. The candidate remains unaccepted and authorizes
no runtime, facility access, scheduling decision, or 50S.7+ work.
