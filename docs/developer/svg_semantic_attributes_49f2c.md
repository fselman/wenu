...
`stars` paint role. This observed distinction is intentional and
...
All 232 resolved to documented exact paint roles; there were no custom or
unknown paint positions.
...
round trip, both files contained exactly 232 semantic artists, identical layer and paint-role
counts. Inkscape therefore preserves
...
- explicit layer, exact zorder, and paint-role data attributes;
...
- parent semantic or semantic-fragment groups;
