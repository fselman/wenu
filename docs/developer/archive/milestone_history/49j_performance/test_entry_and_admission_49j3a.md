...
Initial focused Mac verification passed all 83 current-documentation tests in
2.12 seconds. Final pre-merge verification passed the same 83 tests in 2.43
seconds.
