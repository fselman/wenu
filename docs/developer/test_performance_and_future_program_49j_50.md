...
as the bounded acceptance specimen. 50A.3D, the explicit-center CLI work,
50A.3G acceptance, and 50A.3I automatic numbered-asteroid preflight are
implemented and accepted. 50A.4 is next.
