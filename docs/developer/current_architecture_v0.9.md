...
## Drawable Ceres point and track (Milestone 50A.3B open)

`drawable_ceres_50a3b.md` records the implemented, not yet accepted, bounded
...
ordinary route. The implementation awaits Fernando's macOS scientific and
visual acceptance.
