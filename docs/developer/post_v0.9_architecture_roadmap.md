...
It defines manifest-backed selection of any installed numbered asteroid, with
unnamed main-belt object `(79989)` as the acceptance specimen. Authorized
50A.3D implements and validates that contract without object-specific runtime
branching; 50A.4 remains next afterward.
