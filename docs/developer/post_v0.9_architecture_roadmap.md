...
50A.3B is implemented and awaiting Fernando's macOS scientific and visual
acceptance in `drawable_ceres_50a3b.md`. It connects only `(1) Ceres` through
...
field-query claim. 50A.3 remains open until that evidence is accepted.
